// Outliers CRM - admin lista todos os profiles (bypass RLS via service role)
...
export default async function handler(req, res) {
  ...
  try {
    ...
    var r = await admin.from('profiles').select('id, nome, email, role, telefone, pix, created_at').order('created_at', { ascending: false })
